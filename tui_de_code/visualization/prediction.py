...
a = np.transpose(np.concatenate(predictions, 0), [1,2,0]) 
new_image = nib.Nifti1Image(a, np.eye(4)) 
nib.save(new_image, 'Patient_01.nii.gz')
print(a.shape)
print(np.concatenate(targets, 0).shape)
